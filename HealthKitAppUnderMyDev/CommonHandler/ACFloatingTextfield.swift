...
@objc open class ACFloatingTextfield: UITextField {
    ...
    @IBInspectable open var lineColor : UIColor = .clear {//UIColor.black {
        didSet{
            self.floatTheLabel()
        }
    }
    ...
    @IBInspectable open var selectedLineColor : UIColor = .clear { //UIColor(red: 19/256.0, green: 141/256.0, blue: 117/256.0, alpha: 1.0){
        didSet{
            self.floatTheLabel()
        }
    }
    ...
    @IBInspectable open var textPlaceHolderColor : UIColor = UIColor.lightGray {
        didSet{
            self.floatTheLabel()
        }
    }
    ...
    @IBInspectable open var selectedPlaceHolderColor : UIColor = UIColor(red: 25/256.0, green: 93/256.0, blue: 194/256.0, alpha: 1.0){ //UIColor(red: 19/256.0, green: 141/256.0, blue: 117/256.0, alpha: 1.0){
        didSet{
            self.floatTheLabel()
        }
    }
    ...
    override open func textRect(forBounds bounds: CGRect) -> CGRect {
        return CGRect(x:0, y:5, width:bounds.size.width, height:(bounds.size.height - 15.0));
    }
...
fileprivate extension ACFloatingTextfield {
    ...
    func addBottomLine(){
        ...
        let bottomConstraint = NSLayoutConstraint.init(item: bottomLineView!, attribute: .bottom, relatedBy: .equal, toItem: self, attribute: .bottom, multiplier: 1, constant: -15)
    ...
    func addFloatingLabel(){
        ...
        labelPlaceholder?.textColor = textPlaceHolderColor
        labelPlaceholder?.font = UIFont.init(name: Constants.FontTypes.Inter.Regular, size: 11) //(self.font?.fontName ?? "helvetica")!, size: 11)//12//kupe code
        labelPlaceholder?.isHidden = true
        labelPlaceholder?.sizeToFit()
        labelPlaceholder?.translatesAutoresizingMaskIntoConstraints = false
        self.attributedPlaceholder = NSAttributedString(string: placeholder ?? "", attributes: [NSAttributedString.Key.foregroundColor: textPlaceHolderColor])
    ...
    func addErrorPlaceholderLabel() -> Void {
        ...
        labelErrorPlaceholder?.font = UIFont(name: Constants.FontTypes.Inter.Regular, size: 11) //(self.font?.fontName ?? "helvetica")!, size: 11)//12//kupe code
        ...
        self.bringSubviewToFront(labelErrorPlaceholder!)
        
        let trailingConstraint = NSLayoutConstraint.init(item: labelErrorPlaceholder!, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1, constant: 0)
//        let topConstraint = NSLayoutConstraint.init(item: labelErrorPlaceholder!, attribute: .top, relatedBy: .equal, toItem: self, attribute: .bottom, multiplier: 1, constant: -10)
        let topConstraint = NSLayoutConstraint.init(item: labelErrorPlaceholder!, attribute: .top, relatedBy: .equal, toItem: self, attribute: .bottom, multiplier: 1, constant: -(15+6)) //-15//kupe code
    ...
    func floatPlaceHolder(selected:Bool) -> Void {
        ...
        if selected {
            ...
            self.labelPlaceholder?.textColor = self.textPlaceHolderColor
            self.attributedPlaceholder = NSAttributedString(string: placeholder ?? "", attributes: [NSAttributedString.Key.foregroundColor: textPlaceHolderColor])
        }
